...
export const newsletters = pgTable(
  ...
  (table) => ({ ownerIdx: index('newsletters_owner_idx').on(table.ownerId) }),
);
export const assets = pgTable(
  ...
  (table) => ({ ownerIdx: index('assets_owner_idx').on(table.ownerId) }),
);
export const appSettings = pgTable(
  ...
  (table) => ({ ownerIdx: index('app_settings_owner_idx').on(table.ownerId) }),
);
