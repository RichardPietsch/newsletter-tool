export const de = {
  ...
  misc: {
    ...
    eventLibraryIntro: 'Pflege Veranstaltungen zentral und verwende sie als unabhängige Kopien in Newslettern.',
    ...
    chooseFromRegister: 'Aus Event-Register auswählen',
    replaceFromRegister: 'Durch Register-Event ersetzen',
    eventSnapshotHint: 'Die Auswahl wird als unabhängige Kopie in diesen Newsletter übernommen.',
    speakerName: 'Speaker-Name',
    speakerRole: 'Funktion / Jobtitel',
    talkTitle: 'Vortragstitel',
    moveEarlier: 'Weiter nach vorne',
    moveLater: 'Weiter nach hinten',
    remove: 'Entfernen',
    category: 'Kategorie',
