  ...
  return (
    <nav className="sticky top-0 z-20 flex h-screen w-20 shrink-0 flex-col items-center gap-3 border-r bg-white py-4" aria-label="Funktionsleiste">
      ...
      <div className="mt-auto flex flex-col items-center gap-3">
        {onOpenNewsletterSettings ? <RailButton onClick={onOpenNewsletterSettings} label="Newsletter-Einstellungen"><MdiIcon name="emailCheck" className="h-7 w-7" /></RailButton> : null}
