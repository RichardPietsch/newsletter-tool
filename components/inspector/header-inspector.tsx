  ...
  return (
    <div className="space-y-4">
      ...
      <label className="block text-sm font-medium">
        Header-Variante
        <select className="mt-2 w-full rounded border p-2" value={block.headerVariantId ?? ''} onChange={(event) => onChange({ headerVariantId: event.target.value || undefined })}>
          <option value="">Standard-Branding</option>
